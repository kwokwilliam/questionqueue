...
| P3       | As a student          | I want to be able to remove myself from the queue if I have figured out the problem and/or have a new problem.                                                                   |

### API Design

#### Auth and User Queue Microservice Endpoints
...
#### Admin Queue Microservice Endpoints
...
#### Original Infrastructure Diagram (Project Proposal Submission)

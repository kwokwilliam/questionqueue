...
func TestUsersHandler(t *testing.T) {
	...
	cases := []struct {
		...
		},
		{
			...
			method:       "POST",
			endpoint:     "/v1/users",
			jsonString:   `{"email": "abc@cdf.com", "userName": "aasdf", "password":"password", "passwordConf":"mismatch"}`,
			expectedCode: http.StatusInternalServerError,
		},
		{
			...
			method:   "POST",
			endpoint: "/v1/users",
			jsonString: `{"email": "abc@cdf.com", "userName": "aasdf", "password":"password2", "passwordConf":"password2",
